...
public class BackgroundActivity2 extends StatusBar  {
    ...
    private void showNormalDialog(int id) {
        ...
        final AlertDialog.Builder normalDialog = new AlertDialog.Builder(BackgroundActivity2.this);
        ...
        call1.enqueue(new Callback<Background>() {
            ...
            public void onResponse(Call<Background> call, Response<Background> response) {
                if (response.code() == 200) {
                    Toast.makeText(BackgroundActivity2.this, "兑换成功", Toast.LENGTH_SHORT).show();
                    changeRequest(id);
                } else if (response.code() == 203) {
                    Toast.makeText(BackgroundActivity2.this, "金币不足！快去打卡赚金币吧~", Toast.LENGTH_SHORT).show();
                } else if (response.code() == 400) {
                    Toast.makeText(BackgroundActivity2.this, "出错啦！请稍后再试~", Toast.LENGTH_SHORT).show();
                } else if (response.code() == 401) {
                    Toast.makeText(BackgroundActivity2.this, "身份认证出错啦！", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(BackgroundActivity2.this, "出错啦！稍后再试~", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<Background> call, Throwable t) {
                Toast.makeText(BackgroundActivity2.this, "出错啦！请检查网络连接~", Toast.LENGTH_SHORT).show();
            }
        });
    }

    private void request() {        //获取当前的背景id
        Retrofit.Builder builder1 = new Retrofit.Builder()
